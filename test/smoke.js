...
console.log('== resolver: require class var ==');
const docReq =
...
console.log('== resolver: instancia via find ==');
const docInst =
  "local Regra = require('Pedido.Regra')\n" +
...
console.log('== resolver: navegacao por relacao ==');
...
const docChain =
  ...
  'local reg = Regra.find{ id = 1 }\n' +
  'print(reg.items[1].';
r = resolver.resolve(index, docChain, 'print(reg.items[1].');
